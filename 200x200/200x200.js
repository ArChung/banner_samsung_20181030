...
lib.ssMetadata = [
		{name:"200x200_atlas_", frames: [[0,478,169,124],[0,0,403,250],[366,440,111,40],[457,80,43,43],[405,80,50,92],[0,252,244,224],[246,440,118,213],[405,0,79,78],[404,252,83,83],[405,221,17,19],[455,174,43,50],[405,174,48,45],[246,252,156,186]]}
];
...
(lib.元件53 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-26,32,0.431,0.431);
...
}).prototype = getMCSymbolPrototype(lib.元件53, new cjs.Rectangle(-30.8,32,77.8,87.2), null);
...
(lib.元件24 = function(mode,startPosition,loop) {
	...
	this.instance_1 = new lib.元件30();
	this.instance_1.parent = this;
	this.instance_1.setTransform(16.9,53.9,1,1,0,0,0,8.5,9.5);
...
p.nominalBounds = new cjs.Rectangle(8.4,6.8,243.6,56.6);
...
(lib._200x200 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(173.2,17.3,0.327,0.327,0,0,0,124,18.4);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(39.9,16.2,0.805,0.805,0,0,0,35.6,6);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(59.1,95.1,0.777,0.805,0,0,0,61.6,29.6);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(100).to({_off:false},0).to({regY:29.5,y:88.7},7,cjs.Ease.cubicOut).wait(148));

	// p3.png
	this.instance_3 = new lib.元件53();
	this.instance_3.parent = this;
	this.instance_3.setTransform(116.1,140.4,0.805,0.805,0,0,0,111.1,29.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(102).to({_off:false},0).to({y:133.9,alpha:1},8,cjs.Ease.cubicOut).wait(145));

	// hand.png
	this.instance_4 = new lib.元件40();
	this.instance_4.parent = this;
	this.instance_4.setTransform(130.3,187.3,0.805,0.805,0,0,0,86,24.6);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(104).to({_off:false},0).to({y:180.8,alpha:1},9,cjs.Ease.cubicOut).wait(142));

	// 圖層 6
	this.instance_5 = new lib.元件57();
	this.instance_5.parent = this;
	this.instance_5.setTransform(166.8,118,0.751,0.751,0,0,0,122.1,112.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(98).to({_off:false},0).to({x:142.7,alpha:1},7,cjs.Ease.get(1)).wait(150));

	// 圖層 7
	this.instance_6 = new lib.補間動畫6("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-28.8,206.4,0.805,0.805,4.7);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).to({regX:0.1,regY:0.1,x:13.6,y:206.2,alpha:1},7,cjs.Ease.get(1)).wait(150));

	// ttt2.png
	this.instance_7 = new lib.元件47();
	this.instance_7.parent = this;
	this.instance_7.setTransform(102.8,71.9,0.11,0.115,0,0,0,186.5,50.9);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(49).to({_off:false},0).to({regX:186.2,regY:50.8,scaleX:0.3,scaleY:0.32,x:101.6,y:63.7,alpha:1},5,cjs.Ease.quadInOut).to({regY:50.6,scaleX:0.27,scaleY:0.28,x:101.7,y:64.3},3,cjs.Ease.quadInOut).wait(30).to({alpha:0},8,cjs.Ease.quadInOut).to({_off:true},1).wait(159));

	// ttt1.png
	this.instance_8 = new lib.元件48();
	this.instance_8.parent = this;
	this.instance_8.setTransform(99.5,33.8,0.474,0.496,0,0,0,299.9,59);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(45).to({_off:false},0).to({regX:300.3,regY:59.1,scaleX:0.31,scaleY:0.32,y:38.9},5,cjs.Ease.quadInOut).to({scaleX:0.32,scaleY:0.34,y:38.5},3,cjs.Ease.quadInOut).wait(34).to({alpha:0},8,cjs.Ease.quadInOut).to({_off:true},1).wait(159));

	// 圖層 19
	this.instance_9 = new lib.元件24();
	this.instance_9.parent = this;
	this.instance_9.setTransform(96.9,115.5,0.805,0.805,0,0,0,118.5,40.5);
	...
	this.instance_10.setTransform(96.6,287.8,0.805,0.805,0,0,0,150,125.1);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(40).to({_off:false},0).to({regX:150.1,scaleX:0.56,scaleY:0.56,y:135.8},11,cjs.Ease.quadInOut).to({regX:150.2,regY:125.2,scaleX:0.56,scaleY:0.56,y:133.7},1).wait(37).to({alpha:0},8).to({_off:true},1).wait(157));

	// m2.png
	this.w2 = new lib.元件20();
	this.w2.parent = this;
	this.w2.setTransform(228.4,262.3,1.357,1.357,0,0,0,41.6,41.6);
	this.w2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.w2).wait(40).to({_off:false},0).to({regY:41.5,scaleX:0.81,scaleY:0.81,x:165.9,y:166.2},12,cjs.Ease.cubicInOut).wait(37).to({alpha:0},7).to({_off:true},1).wait(158));

	// m1.png
	this.instance_11 = new lib.元件22();
	this.instance_11.parent = this;
	this.instance_11.setTransform(-29.8,253.9,1.357,1.357,0,0,0,39.5,39);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(40).to({_off:false},0).to({scaleX:0.81,scaleY:0.81,x:36.2,y:168.6},12,cjs.Ease.cubicInOut).wait(37).to({alpha:0},7).to({_off:true},1).wait(158));

	// 圖層 2
	this.instance_12 = new lib.元件24複製();
	this.instance_12.parent = this;
	this.instance_12.setTransform(96.9,115.5,0.588,0.588,0,0,0,118.5,40.5);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(6).to({_off:false},0).to({scaleX:0.9,scaleY:0.9,x:97,alpha:1},9,cjs.Ease.quadInOut).to({scaleX:0.81,scaleY:0.81,x:96.9},5,cjs.Ease.quadInOut).wait(18).to({regX:118.6,regY:40.6,scaleX:0.71,scaleY:0.71,x:97.4,y:120.4,alpha:0},10,cjs.Ease.get(-1)).to({_off:true},1).wait(206));

	// 圖層 3
	this.instance_13 = new lib.元件56();
	this.instance_13.parent = this;
	this.instance_13.setTransform(103.8,163,0.805,0.805,0,0,0,59.1,106.5);
	this.instance_13.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({y:155,alpha:1},9,cjs.Ease.get(1)).wait(29).to({regY:106.6,scaleX:0.71,scaleY:0.71,x:103.5,alpha:0},10,cjs.Ease.get(-1)).to({_off:true},1).wait(206));

	// t1.png
	this.instance_14 = new lib.元件2();
	this.instance_14.parent = this;
	this.instance_14.setTransform(99.5,37,1.375,1.375,0,0,0,118.5,26.2);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({regX:118.6,regY:26,scaleX:0.77,scaleY:0.77,x:99.4,y:40.8},8,cjs.Ease.quadInOut).to({regY:26.1,scaleX:0.82,scaleY:0.82,y:40.2},5,cjs.Ease.quadInOut).to({scaleX:0.81,scaleY:0.81,y:40.4},4,cjs.Ease.quadInOut).wait(17).to({scaleX:0.6,scaleY:0.6,y:42.7,alpha:0},10,cjs.Ease.cubicIn).to({_off:true},1).wait(206));

	// bg
	this.instance_15 = new lib.元件55();
	this.instance_15.parent = this;
	this.instance_15.setTransform(99,100.7,0.805,0.805,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(255));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(78.3,100.1,242.2,248.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/200x200_atlas_.png?1540882985205", id:"200x200_atlas_"}
	],
	preloads: []
};
