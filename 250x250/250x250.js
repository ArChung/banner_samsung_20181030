...
lib.ssMetadata = [
		{name:"250x250_atlas_", frames: [[0,478,169,124],[0,0,403,250],[366,440,111,40],[457,80,43,43],[405,80,50,92],[0,252,244,224],[246,440,118,213],[405,0,79,78],[404,252,83,83],[405,221,17,19],[455,174,43,50],[405,174,48,45],[246,252,156,186]]}
];
...
(lib._250x250 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(215.3,21.5,0.406,0.406,0,0,0,123.9,18.4);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(73.5,118.1,0.965,1,0,0,0,61.6,29.5);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(144.3,174.4,1,1,0,0,0,111,29.8);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(162,232.6,1,1,0,0,0,86,24.5);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(104).to({_off:false},0).to({y:224.6,alpha:1},9,cjs.Ease.cubicOut).wait(142));

	// 圖層 6
	this.instance_5 = new lib.元件57();
	this.instance_5.parent = this;
	this.instance_5.setTransform(207.2,146.6,0.933,0.933,0,0,0,122,112.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(98).to({_off:false},0).to({x:177.4,alpha:1},7,cjs.Ease.get(1)).wait(150));

	// 圖層 7
	this.instance_6 = new lib.補間動畫6("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-35.7,256.5,1,1,4.7);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).to({x:16.9,y:256,alpha:1},7,cjs.Ease.get(1)).wait(150));

	// ttt2.png
	this.instance_7 = new lib.元件47();
	this.instance_7.parent = this;
	this.instance_7.setTransform(127.8,89.2,0.137,0.143,0,0,0,186.3,50.4);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(49).to({_off:false},0).to({regX:186.1,regY:50.6,scaleX:0.38,scaleY:0.39,x:126.4,y:79.1,alpha:1},5,cjs.Ease.quadInOut).to({regY:50.5,scaleX:0.33,scaleY:0.35,x:126.5,y:79.9},3,cjs.Ease.quadInOut).wait(30).to({alpha:0},8,cjs.Ease.quadInOut).to({_off:true},1).wait(159));

	// ttt1.png
	this.instance_8 = new lib.元件48();
	this.instance_8.parent = this;
	this.instance_8.setTransform(123.7,41.9,0.589,0.616,0,0,0,300,59);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(45).to({_off:false},0).to({regX:300.2,scaleX:0.39,scaleY:0.4,y:48.2},5,cjs.Ease.quadInOut).to({scaleX:0.4,scaleY:0.42,y:47.8},3,cjs.Ease.quadInOut).wait(34).to({alpha:0},8,cjs.Ease.quadInOut).to({_off:true},1).wait(159));

	// 圖層 19
	this.instance_9 = new lib.元件24();
	this.instance_9.parent = this;
	this.instance_9.setTransform(120.5,143.5,1,1,0,0,0,118.5,40.5);
	...
	this.instance_10.setTransform(120,357.5,1,1,0,0,0,150,125);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(40).to({_off:false},0).to({regY:125.1,scaleX:0.7,scaleY:0.7,x:120.1,y:168.7},11,cjs.Ease.quadInOut).to({regX:150.1,regY:125,scaleX:0.69,scaleY:0.69,y:166},1).wait(37).to({alpha:0},8).to({_off:true},1).wait(157));

	// m2.png
	this.w2 = new lib.元件20();
	this.w2.parent = this;
	this.w2.setTransform(283.9,326,1.687,1.687,0,0,0,41.6,41.6);
	this.w2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.w2).wait(40).to({_off:false},0).to({regX:41.5,regY:41.5,scaleX:1,scaleY:1,x:206.2,y:206.5},12,cjs.Ease.cubicInOut).wait(37).to({alpha:0},7).to({_off:true},1).wait(158));

	// m1.png
	this.instance_11 = new lib.元件22();
	this.instance_11.parent = this;
	this.instance_11.setTransform(-37,315.4,1.687,1.687,0,0,0,39.5,39);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(40).to({_off:false},0).to({scaleX:1,scaleY:1,x:45,y:209.5},12,cjs.Ease.cubicInOut).wait(37).to({alpha:0},7).to({_off:true},1).wait(158));

	// 圖層 2
	this.instance_12 = new lib.元件24複製();
	this.instance_12.parent = this;
	this.instance_12.setTransform(120.5,143.5,0.73,0.73,0,0,0,118.5,40.5);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(6).to({_off:false},0).to({scaleX:1.11,scaleY:1.11,alpha:1},9,cjs.Ease.quadInOut).to({scaleX:1,scaleY:1},5,cjs.Ease.quadInOut).wait(18).to({regX:118.6,scaleX:0.88,scaleY:0.88,x:121.2,y:149.5,alpha:0},10,cjs.Ease.get(-1)).to({_off:true},1).wait(206));

	// 圖層 3
	this.instance_13 = new lib.元件56();
	this.instance_13.parent = this;
	this.instance_13.setTransform(129,202.5,1,1,0,0,0,59,106.5);
	this.instance_13.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({y:192.5,alpha:1},9,cjs.Ease.get(1)).wait(29).to({regY:106.6,scaleX:0.88,scaleY:0.88,x:128.6,y:192.6,alpha:0},10,cjs.Ease.get(-1)).to({_off:true},1).wait(206));

	// t1.png
	this.instance_14 = new lib.元件2();
	this.instance_14.parent = this;
	this.instance_14.setTransform(123.7,45.9,1.709,1.709,0,0,0,118.5,26.2);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({regY:26.1,scaleX:0.95,scaleY:0.95,x:123.5,y:50.7},8,cjs.Ease.quadInOut).to({regY:26,scaleX:1.02,scaleY:1.02,y:49.8},5,cjs.Ease.quadInOut).to({scaleX:1,scaleY:1,y:50},4,cjs.Ease.quadInOut).wait(17).to({scaleX:0.74,scaleY:0.74,y:53,alpha:0},10,cjs.Ease.cubicIn).to({_off:true},1).wait(206));

	// bg
	this.instance_15 = new lib.元件55();
	this.instance_15.parent = this;
	this.instance_15.setTransform(123,125,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(255));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(98,125,301,309);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/250x250_atlas_.png?1540882924523", id:"250x250_atlas_"}
	],
	preloads: []
};
