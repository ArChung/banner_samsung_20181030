...
lib.ssMetadata = [
		{name:"320x50_atlas_", frames: [[0,478,169,124],[0,0,403,250],[366,440,111,40],[457,80,43,43],[405,80,50,92],[0,252,244,224],[246,440,118,213],[405,0,79,78],[404,252,83,83],[405,221,17,19],[455,174,43,50],[405,174,48,45],[246,252,156,186]]}
];
...
(lib.元件34 = function(mode,startPosition,loop) {
	...
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(83.1,14.6);
...
(lib._320x50 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(47.1,50,0.573,0.593,4.2,0,0,61.6,29.8);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(100).to({_off:false},0).to({regY:29.7,x:47.4,y:45.2},7,cjs.Ease.cubicOut).wait(148));

	// p3.png
	this.instance_3 = new lib.元件53();
	this.instance_3.parent = this;
	this.instance_3.setTransform(191.5,14.3,0.506,0.506,0,0,0,111.2,29.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(102).to({_off:false},0).to({regY:29.7,y:10.3,alpha:1},8,cjs.Ease.cubicOut).wait(145));

	// hand.png
	this.instance_4 = new lib.元件40();
	this.instance_4.parent = this;
	this.instance_4.setTransform(211.7,33.3,0.639,0.639,0,0,0,86,24.6);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(104).to({_off:false},0).to({regY:24.7,y:28.2,alpha:1},9,cjs.Ease.cubicOut).wait(142));

	// 圖層 6
	this.instance_5 = new lib.元件57();
	this.instance_5.parent = this;
	this.instance_5.setTransform(298.1,27.4,0.243,0.243,0,0,0,122,112.3);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(98).to({_off:false},0).to({regX:122.2,x:290.3,alpha:1},7,cjs.Ease.get(1)).wait(150));

	// 圖層 7
	this.instance_6 = new lib.補間動畫6("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(231.2,70.6,0.805,0.805,4.7);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).to({regX:0.1,regY:0.1,x:273.6,y:70.4,alpha:1},7,cjs.Ease.get(1)).wait(150));

	// ttt2.png
	this.instance_7 = new lib.元件47();
	this.instance_7.parent = this;
	this.instance_7.setTransform(122,44.8,0.098,0.102,1.9,0,0,187.6,51.1);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(49).to({_off:false},0).to({regX:186.8,scaleX:0.27,scaleY:0.28,x:121.2,y:37.6,alpha:1},5,cjs.Ease.quadInOut).to({regY:50.8,scaleX:0.24,scaleY:0.25,y:38.1},3,cjs.Ease.quadInOut).wait(30).to({alpha:0},8,cjs.Ease.quadInOut).to({_off:true},1).wait(159));

	// ttt1.png
	this.instance_8 = new lib.元件48();
	this.instance_8.parent = this;
	this.instance_8.setTransform(120.2,12.5,0.422,0.441,1.9,0,0,299.8,58.9);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(45).to({_off:false},0).to({regX:300.8,regY:59.1,scaleX:0.28,scaleY:0.29,x:120,y:17},5,cjs.Ease.quadInOut).to({regX:300.5,regY:59,scaleX:0.29,scaleY:0.3,y:16.7},3,cjs.Ease.quadInOut).wait(34).to({alpha:0},8,cjs.Ease.quadInOut).to({_off:true},1).wait(159));

	// 圖層 19
	this.instance_9 = new lib.元件24();
	this.instance_9.parent = this;
	this.instance_9.setTransform(259.5,18.9,0.373,0.373,0,0,0,118.6,40.6);
	...
	this.instance_10.setTransform(259.3,98.8,0.373,0.373,0,0,0,150,125.1);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(40).to({_off:false},0).to({regX:150.3,regY:125,scaleX:0.26,scaleY:0.26,y:28.3},11,cjs.Ease.quadInOut).to({regY:125.3,scaleX:0.26,scaleY:0.26,y:27.3},1).wait(37).to({alpha:0},8).to({_off:true},1).wait(157));

	// m2.png
	this.w2 = new lib.元件20();
	this.w2.parent = this;
	this.w2.setTransform(327.7,77.8,0.63,0.63,0,0,0,41.6,41.6);
	this.w2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.w2).wait(40).to({_off:false},0).to({regY:41.5,scaleX:0.37,scaleY:0.37,x:298.7,y:33.2},12,cjs.Ease.cubicInOut).wait(37).to({alpha:0},7).to({_off:true},1).wait(158));

	// m1.png
	this.instance_11 = new lib.元件22();
	this.instance_11.parent = this;
	this.instance_11.setTransform(193.1,73.6,0.63,0.63,0,0,0,39.6,39.1);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(40).to({_off:false},0).to({scaleX:0.37,scaleY:0.37,x:223.7,y:33.9},12,cjs.Ease.cubicInOut).wait(37).to({alpha:0},7).to({_off:true},1).wait(158));

	// 圖層 2
	this.instance_12 = new lib.元件24複製();
	this.instance_12.parent = this;
	this.instance_12.setTransform(223.1,19.5,0.247,0.247,0,0,0,118.4,40.7);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(6).to({_off:false},0).to({regX:118.6,regY:40.6,scaleX:0.38,scaleY:0.38,alpha:1},9,cjs.Ease.quadInOut).to({regX:118.5,scaleX:0.34,scaleY:0.34},5,cjs.Ease.quadInOut).wait(18).to({regX:118.8,scaleX:0.3,scaleY:0.3,x:223.3,y:21.5,alpha:0},10,cjs.Ease.get(-1)).to({_off:true},1).wait(206));

	// 圖層 3
	this.instance_13 = new lib.元件56();
	this.instance_13.parent = this;
	this.instance_13.setTransform(226,39.4,0.338,0.338,0,0,0,59.1,106.6);
	this.instance_13.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({y:36.1,alpha:1},9,cjs.Ease.get(1)).wait(29).to({regX:59.2,regY:106.7,scaleX:0.3,scaleY:0.3,x:225.8,alpha:0},10,cjs.Ease.get(-1)).to({_off:true},1).wait(206));

	// t1.png
	this.instance_14 = new lib.元件2();
	this.instance_14.parent = this;
	this.instance_14.setTransform(105,14.9,1.189,1.189,2.5,0,0,118.4,26.1);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({regX:118.7,regY:25.9,scaleX:0.66,scaleY:0.66,rotation:2.4,x:104.8,y:18.2},8,cjs.Ease.quadInOut).to({regX:118.6,scaleX:0.71,scaleY:0.71,rotation:2.5,y:17.6},5,cjs.Ease.quadInOut).to({scaleX:0.7,scaleY:0.7,rotation:2.4,y:17.9},4,cjs.Ease.quadInOut).wait(17).to({regX:118.7,regY:26.2,scaleX:0.52,scaleY:0.52,rotation:2.5,x:104.7,y:19.9,alpha:0},10,cjs.Ease.cubicIn).to({_off:true},1).wait(206));

	// bg
	this.instance_15 = new lib.元件55();
	this.instance_15.parent = this;
	this.instance_15.setTransform(160,25,1.067,0.2,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(255));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(139,25,341,202.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/320x50_atlas_.png?1540883484227", id:"320x50_atlas_"}
	],
	preloads: []
};
