...
lib.ssMetadata = [
		{name:"970x250_atlas_", frames: [[0,478,169,124],[0,0,403,250],[366,440,111,40],[457,80,43,43],[405,80,50,92],[0,252,244,224],[246,440,118,213],[405,0,79,78],[404,252,83,83],[405,221,17,19],[455,174,43,50],[405,174,48,45],[246,252,156,186]]}
];
...
(lib.補間動畫6 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(543.3,-147.6,1.355,1.355,-6);

	this.instance_1 = new lib.圖層1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(273.2,-169.3,1.355,1.355,-6);

	this.instance_2 = new lib.圖層1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(62.6,-161.6,1.355,1.355,-6);
	...
	this.instance_3.setTransform(75,-194,1.355,1.355);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(62.6,-226.4,1059.4,415.8);
...
(lib.元件53 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(65.5,78.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.元件53, new cjs.Rectangle(-30.8,25,127.5,94.2), null);
...
(lib._970x250 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(903.6,21.5,0.406,0.406,0,0,0,123.9,18.4);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(219.6,212.9,2.056,2.056,0,0,0,61.5,29.6);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(100).to({_off:false},0).to({y:196.4},7,cjs.Ease.cubicOut).wait(148));

	// p3.png
	this.instance_3 = new lib.元件53();
	this.instance_3.parent = this;
	this.instance_3.setTransform(703.3,79.1,1.275,1.275,0,0,0,111.1,29.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(102).to({_off:false},0).to({scaleX:1.62,scaleY:1.62,x:751.2,y:69.2,alpha:1},8,cjs.Ease.cubicOut).wait(145));

	// hand.png
	this.instance_4 = new lib.元件40();
	this.instance_4.parent = this;
	this.instance_4.setTransform(602.2,215.4,1.402,1.402,0,0,0,86,24.5);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(104).to({_off:false},0).to({regY:24.6,y:204.3,alpha:1},9,cjs.Ease.cubicOut).wait(142));

	// 圖層 6
	this.instance_5 = new lib.元件57();
	this.instance_5.parent = this;
	this.instance_5.setTransform(872.7,133,1.057,1.057,0,0,0,122,112);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(98).to({_off:false},0).to({x:838.9,alpha:1},7,cjs.Ease.get(1)).wait(150));

	// 圖層 7
	this.instance_6 = new lib.補間動畫6("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(331.8,196.9,1,1,4.7);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).to({x:384.4,y:196.5,alpha:1},7,cjs.Ease.get(1)).wait(150));

	// ttt2.png
	this.instance_7 = new lib.元件47();
	this.instance_7.parent = this;
	this.instance_7.setTransform(320.7,191.4,0.3,0.31,0,0,0,186.1,50.4);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(49).to({_off:false},0).to({regX:186.2,regY:50.7,scaleX:0.82,scaleY:0.85,x:317.6,y:169.5,alpha:1},5,cjs.Ease.quadInOut).to({regX:186,regY:50.6,scaleX:0.73,scaleY:0.75,x:317.7,y:171.2},3,cjs.Ease.quadInOut).wait(30).to({alpha:0},8,cjs.Ease.quadInOut).to({_off:true},1).wait(159));

	// ttt1.png
	this.instance_8 = new lib.元件48();
	this.instance_8.parent = this;
	this.instance_8.setTransform(311.8,88.6,1.293,1.339,0,0,0,300.1,59);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(45).to({_off:false},0).to({regX:300.2,scaleX:0.85,scaleY:0.88,x:311.7,y:102.4},5,cjs.Ease.quadInOut).to({scaleX:0.88,scaleY:0.91,y:101.4},3,cjs.Ease.quadInOut).wait(34).to({alpha:0},8,cjs.Ease.quadInOut).to({_off:true},1).wait(159));

	// 圖層 19
	this.instance_9 = new lib.元件24();
	this.instance_9.parent = this;
	this.instance_9.setTransform(755.4,102.4,1.269,1.269,0,0,0,118.6,40.6);
	...
	this.instance_10.setTransform(754.8,374.1,1.269,1.269,0,0,0,150.1,125.1);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(40).to({_off:false},0).to({scaleX:0.88,scaleY:0.88,y:134.3},11,cjs.Ease.quadInOut).to({regX:150.2,regY:125,scaleX:0.88,scaleY:0.88,y:130.9},1).wait(37).to({alpha:0},8).to({_off:true},1).wait(157));

	// m2.png
	this.w2 = new lib.元件20();
	this.w2.parent = this;
	this.w2.setTransform(978.4,333.9,2.141,2.141,0,0,0,41.6,41.6);
	this.w2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.w2).wait(40).to({_off:false},0).to({scaleX:1.27,scaleY:1.27,x:879.8,y:182.4},12,cjs.Ease.cubicInOut).wait(37).to({alpha:0},7).to({_off:true},1).wait(158));

	// m1.png
	this.instance_11 = new lib.元件22();
	this.instance_11.parent = this;
	this.instance_11.setTransform(547.3,309.8,2.141,2.141,0,0,0,39.6,39);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(40).to({_off:false},0).to({regY:39.1,scaleX:1.27,scaleY:1.27,x:651.3,y:175.5},12,cjs.Ease.cubicInOut).wait(37).to({alpha:0},7).to({_off:true},1).wait(158));

	// 圖層 2
	this.instance_12 = new lib.元件24複製();
	this.instance_12.parent = this;
	this.instance_12.setTransform(710.3,90,0.825,0.825,0,0,0,118.5,40.5);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(6).to({_off:false},0).to({scaleX:1.26,scaleY:1.26,alpha:1},9,cjs.Ease.quadInOut).to({regX:118.6,scaleX:1.13,scaleY:1.13},5,cjs.Ease.quadInOut).wait(18).to({regY:40.6,scaleX:0.99,scaleY:0.99,x:711,y:96.7,alpha:0},10,cjs.Ease.get(-1)).to({_off:true},1).wait(206));

	// 圖層 3
	this.instance_13 = new lib.元件56();
	this.instance_13.parent = this;
	this.instance_13.setTransform(719.9,156.7,1.13,1.13,0,0,0,59,106.5);
	this.instance_13.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({y:145.4,alpha:1},9,cjs.Ease.get(1)).wait(29).to({regX:59.1,regY:106.6,scaleX:0.99,scaleY:0.99,x:719.4,alpha:0},10,cjs.Ease.get(-1)).to({_off:true},1).wait(206));

	// t1.png
	this.instance_14 = new lib.元件2();
	this.instance_14.parent = this;
	this.instance_14.setTransform(357.6,96.6,3.516,3.516,0,0,0,118.5,26.2);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({regX:118.6,regY:26.1,scaleX:1.96,scaleY:1.96,x:357.4,y:106.4},8,cjs.Ease.quadInOut).to({regY:26,scaleX:2.1,scaleY:2.1,x:357.5,y:104.6},5,cjs.Ease.quadInOut).to({regX:118.5,regY:26.1,scaleX:2.06,scaleY:2.06,x:357.3,y:105.2},4,cjs.Ease.quadInOut).wait(17).to({scaleX:1.53,scaleY:1.53,y:111.2,alpha:0},10,cjs.Ease.cubicIn).to({_off:true},1).wait(206));

	// bg
	this.instance_15 = new lib.元件55();
	this.instance_15.parent = this;
	this.instance_15.setTransform(485.4,125,3.236,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(255));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(485,125,970.7,277.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/970x250_atlas_.png?1540888819632", id:"970x250_atlas_"}
	],
	preloads: []
};
